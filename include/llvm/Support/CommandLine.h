...
protected:
  explicit Option(enum NumOccurrencesFlag OccurrencesFlag,
      ...
      : NumOccurrences(0), Occurrences(OccurrencesFlag), Value(0),
        ...
        AdditionalVals(0), NextRegistered(0), ArgStr(""), HelpStr(""),
...
public:
  ...
  const char *getDescription(unsigned N) const { return Values[N].HelpStr; }
...
class opt
    : public Option,
      public opt_storage<DataType, ExternalStorage, is_class<DataType>::value> {
  ParserClass Parser;
